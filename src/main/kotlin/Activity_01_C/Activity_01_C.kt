...
You are also tasked to group the items in categories to help manage the grocery.  Use the proper data types.
    ...
    var sheetCount: Int
    var plyCount: Int
    var manufacturingDateToilet: Date
    var expiryDateToilet: Date
    ...
    var manufacturingDatePP: Date
    var expiryDatePP: Date
    ...
    var manufacturingDateShampoo: Date
    var expiryDateShampoo: Date
    ...
    var manufacturingDateTooth: Date
    var expiryDateTooth: Date
    ...
    var alcoholContent: Date
    var manufacturingDateAlc: Date
    var expiryDateAlc: Date
    var carbonatedDrink: String
    var brandNameCarbo: String
    var productNameCarbo: String
    var price: Double
    var netVolumeCarbo: Int
    var manufacturingDateCarbo: Date
    var expiryDateCarbo: Date
}